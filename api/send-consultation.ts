...
ご不明な点がございましたら、お気軽にお問い合わせください。
    ...
    const subject = `【適職診断】面談申込 - ${name}様`;
    const fromAddress = process.env.MAIL_FROM || process.env.SMTP_USER || process.env.EMAIL_USER || 'noreply@tekishoku.vercel.app';

    // SendGridが設定されている場合はSendGridを使用（推奨）
